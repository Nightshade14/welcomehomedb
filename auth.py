...
def create_auth_blueprint(login_manager: LoginManager):
            ...
            if error is None:
                ...
                try:
                    ...
                    cursor.execute(
                        ...
                        "VALUES (%s, %s, %s, %s, %s)",
                        (username, generate_password_hash(password), first_name, last_name,  email_address), # already does salting 
                    )
    ...
    def index():
        if current_user.is_authenticated:
            ...
            return render_template('auth/index.html', fname=current_user.firstname, locations=None, roles=roles)
        return redirect(url_for('auth.login'))
    ...
    def find_item():
        ...
        return render_template('auth/index.html', locations=locations, order_items=None, roles=roles)
    ...
    def find_order_items():
        ...
        return render_template('auth/index.html', order_items=list(order_items.values()), locations=None, roles=roles)
        ...
        if request.method == 'POST':
            ...
            if donor_id:
                ...
                if 'step' in request.form and request.form['step'] == '2':
                    ...
                    pieces = request.form.getlist('pieces')  # Get pieces data from the form
                    ...
                    try:
                        ...
                        cursor.execute(
                            ...
                            """,
                            (item_description, color, True, has_pieces, material, main_category, sub_category),
                        )
                        db.commit()
                        ...
                        if has_pieces:
                            for piece_data in pieces:
                                ...
                                cursor.execute(
                                    ...
                                    """,
                                    (item_id, piece_num, p_description, length, width, height, room_num, shelf_num),
                                )
                        else:
                            ...
                            cursor.execute(
                                ...
                                VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
                                """,
                                (item_id, 1, item_description, None, None, None, None, None),
                            )
                        ...
                        return render_template("auth/accept_donation.html", step=2, donor_id=donor_id, locations=locations)
