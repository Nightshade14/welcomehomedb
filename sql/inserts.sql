...
('Furniture', 'Chair', 'Various types of chairs including office and dining chairs'),
...
('Office Chair with wheels', 'Black', TRUE, FALSE, 'Plastic and Fabric', 'Furniture', 'Chair'),
('Dining Table with 4 legs', 'Brown', TRUE, TRUE, 'Wood', 'Furniture', 'Table'),
('HP EliteBook Laptop', 'Silver', TRUE, FALSE, 'Metal and Plastic', 'Electronics', 'Laptop'),
('Men\'s Cotton Shirt', 'Blue', TRUE, FALSE, 'Cotton', 'Clothing', 'Shirts'),
('Mystery Novel: The Lost Symbol', 'N/A', FALSE, FALSE, 'Paper', 'Books', 'Fiction');

-- Insert into Person table
INSERT INTO Person (userName, pwd, fname, lname, email) VALUES
('johnDoe', 'password123', 'John', 'Doe', 'john.doe@example.com'),
('janeSmith', 'password456', 'Jane', 'Smith', 'jane.smith@example.com'),
('adminUser', 'adminPassword', 'Admin', 'User', 'admin@example.com');
...
(1, 1, 'Office Chair (Complete)', 60, 60, 120, 1, 1, 'Fully assembled chair');

-- Item 2: Dining Table (Multiple Pieces)
INSERT INTO Piece (ItemID, pieceNum, pDescription, length, width, height, roomNum, shelfNum, pNotes) VALUES
(2, 1, 'Dining table top', 200, 100, 5, 1, 1, 'Main surface of the table'),
(2, 2, 'Dining table leg', 10, 10, 100, 1, 1, 'Leg support for the table'),
(2, 3, 'Dining table screw set', 1, 1, 1, 1, 2, 'Hardware for assembly');

-- Item 3: Laptop (Single Piece)
INSERT INTO Piece (ItemID, pieceNum, pDescription, length, width, height, roomNum, shelfNum, pNotes) VALUES
(3, 1, 'HP EliteBook Laptop', 35, 25, 2, 1, 1, 'Fully assembled laptop');

-- Item 4: Men\'s Cotton Shirt (Single Piece)
INSERT INTO Piece (ItemID, pieceNum, pDescription, length, width, height, roomNum, shelfNum, pNotes) VALUES
(4, 1, 'Men\'s Cotton Shirt', 0, 0, 0, 1, 1, 'Folded shirt on shelf');

-- Item 5: Mystery Novel (Single Piece)
INSERT INTO Piece (ItemID, pieceNum, pDescription, length, width, height, roomNum, shelfNum, pNotes) VALUES
(5, 1, 'Mystery Novel: The Lost Symbol', 15, 10, 2, 1, 2, 'Book on shelf');


-- Insert into Ordered table
INSERT INTO Ordered (orderDate, orderNotes, supervisor, client) VALUES
('2024-11-15', 'Urgent delivery for client Jane Smith', 'johnDoe', 'janeSmith'),
('2024-11-16', 'Routine order for restocking office supplies', 'johnDoe', 'adminUser');
